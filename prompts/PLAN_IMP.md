...
```bash
veda -S impl-auth-refactor -m fable ...    # Implementing a refactor
veda -S impl-pricing-research -m fable ... # Researching pricing options
veda -S impl-launch-doc -m fable ...       # Drafting a launch document
```
...
Onboard yourself with veda at `~/.pi/agent/old-docs/veda.md` before acting.
Key commands:
