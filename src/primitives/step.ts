/**
 * Step implementation - Single LLM call with typed input/output.
 */
...
/**
 * Create a simple text step that returns raw text output.
 */
...
/**
 * Utility to combine usage stats from multiple steps.
 */
